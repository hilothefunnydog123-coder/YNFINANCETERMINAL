...
def fetch_terminal_data(ticker):
    ...
    return df, s.info, fin, s.options, news
    ...
    with c:
        ...
        with tabs[4]:
            ...
            if GEMINI_API_KEY != "YOUR_ACTUAL_GEMINI_API_KEY_HERE":
                ...
                ai_story = "ERROR: API KEY NOT FOUND. Paste your Gemini key on Line 13 of the source code."
            ...
            st.markdown(f"""
                <div class="gazette-body">
                    ...
                    <div class="gazette-sub">
                        ...
                        <span>SENTIMENT: SENTIENT_AI</span>
                    </div>
